<?php
	...
	if (isset($_POST['submit'])) {
		...
		if($_POST['department'] == 'School Staff') {
			$type = 'Non-Teaching';
		} else {
			$type = 'Faculty';
		}
		...
		if($errorCheck == 0){
			$model = new Model();
			$model->addUser($_POST['employee-id'], $capName, $_POST['contact'], $_POST['email'], $password, $date_added, $status, $type, $_POST['department']);	
			...
			echo "<script>window.open('registration-nonstudent.php','_self');</script>";
		}
			...
			<div class="account-form">
					...
					<div class="second-div">
						...
						<div class="heading-bx left">
							<h2 class="title-head">Registration (Faculty/Non-Teaching) </h2>
						</div>	
