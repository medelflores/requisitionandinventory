<?php
	...
	if (isset($_SESSION['u_sess'])) {
		echo "<script>window.open('property-custodian/index.php','_self');</script>";
	}
				...
				<div class="account-form-inner">
					<div class="account-container">
						<div class="heading-bx left">
							<h2 class="title-head">Laboratory Technician<span> Access</span></h2>
